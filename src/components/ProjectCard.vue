...
<template>
  <div class="project-card glass" :class="project.colorClass">
    <div class="card-glow" :style="{ background: `radial-gradient(circle at 100% 0%, ${project.badgeColor}15 0%, transparent 60%)` }"></div>
    
    <div class="card-header">
      <div class="header-top">
        <span class="badge category-badge" :style="{ color: project.badgeColor, border: `1px solid ${project.badgeColor}30`, background: `${project.badgeColor}0d` }">
          {{ project.categoryName }}
        </span>
        <span class="badge php-badge">
          {{ project.phpVersion }}
        </span>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="features-section">
        ...
        <ul class="features-list">
          <li v-for="(feature, idx) in project.features" :key="idx" class="feature-item">
      ...
      <div class="impact-section" :style="{ borderLeft: `2px solid ${project.badgeColor}80` }">
